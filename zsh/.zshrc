...
plugins=(
  #git
  zsh-autosuggestions # Install this and following plugin using commands found at https://medium.com/@shivam1/make-your-terminal-beautiful-and-fast-with-zsh-shell-and-powerlevel10k-6484461c6efb
